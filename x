...
local LeftArm = getJoint["Left Arm"]
local RightArm = getJoint["Right Arm"]
local LeftLeg = getJoint["Left Leg"]
local RightLeg = getJoint["Right Leg"]
local Head = getJoint["Head"]
local Torso = getJoint["Torso"]
local RootPart = getJoint["HumanoidRootPart"]
...
--
local hum = getJoint["Humanoid"]
local root = getJoint["HumanoidRootPart"]
local rootj = getJoint["RootJoint"]
local RW = getJoint["Right Shoulder"]
local LW = getJoint["Left Shoulder"]
local RH = getJoint["Right Hip"]
local LH = getJoint["Left Hip"]
--
